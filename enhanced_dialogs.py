...
class SmartOCRDialog:
    ...
    def setup_ui(self):
        """Setup the user interface with flexible scrollable layout"""
        ...
        self.setup_scrollable_content(main_frame)
    ...
    def setup_customer_section(self, parent):
        ...
        customer_frame.pack(fill=tk.X, pady=10, padx=5)
    ...
    def setup_ocr_section(self, parent):
        ...
        ocr_frame.pack(fill=tk.X, pady=10, padx=5)
    ...
    def setup_results_section(self, parent):
        """Setup results display section with flexible height"""
    ...
    def setup_scrollable_content(self, parent):
        ...
        scroll_container = tk.Frame(parent, bg='white')
        ...
        # Setup content sections inside scrollable frame
        self.setup_customer_section(self.scrollable_content_frame)
        self.setup_ocr_section(self.scrollable_content_frame)
        self.setup_results_section(self.scrollable_content_frame)

    def setup_action_buttons(self, parent):
        """Setup action buttons fixed at bottom"""
        # إنشاء إطار الأزرار في الأسفل مع تثبيته
        self.button_frame = tk.Frame(parent, bg='#f8f9fa', height=80, relief=tk.RAISED, bd=1)
        self.button_frame.pack(side=tk.BOTTOM, fill=tk.X, pady=(10, 0))
        self.button_frame.pack_propagate(False)  # منع تغيير الحجم

        # إطار داخلي للأزرار
        buttons_inner_frame = tk.Frame(self.button_frame, bg='#f8f9fa')
    ...
    def display_extracted_phones(self, extracted_data):
        ...
        # Create a container for the scrollable phones list
        scroll_container = tk.Frame(self.results_frame, bg='white')
        scroll_container.pack(fill=tk.X, padx=15, pady=10)
    ...
    def update_scroll_region(self):
        """Update scrollable content region"""
        try:
            self.dialog.update_idletasks()
            ...
            if hasattr(self, 'results_frame') and self.results_frame.winfo_exists():
                ...
                self.content_canvas.yview_moveto(0.6)
        except Exception as e:
